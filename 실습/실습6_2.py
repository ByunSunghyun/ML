...
# Step 2 Neural Network's Layer(s)
# Define the sigmoid activator; we ask if we want the sigmoid or its derivative
def sigmoid_act(x, der=False):
    import numpy as np
...
# Step 3 Define the Training as a Function
...
# Step 4 Compute Predictions Evaluation report
...
# step 5 Exporting the predictions and submit them
...
# step 6 The ANN as a Class. An initialization Improvement
'''
